...
exports.generateVerificationEmail = (name, verifyUrl) => `
  <div style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; line-height: 1.6; color: ${COLORS.espresso}; background-color: ${COLORS.cream}; padding: 40px; border-radius: 24px; border: 1px solid ${COLORS.sand};">
    ...
    <p style="font-size: 16px;">Obrigado por se cadastrar no <strong style="color: ${COLORS.terracotta};">Petzara</strong>.</p>
    ...
    <p style="font-size: 12px; color: ${COLORS.taupe};">
      Se você não se registrou no Petzara, pode ignorar este e-mail.
    </p>
  </div>
`;
...
exports.generateResetPasswordEmail = (name, resetUrl) => `
  <div style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; line-height: 1.6; color: ${COLORS.espresso}; background-color: ${COLORS.cream}; padding: 40px; border-radius: 24px; border: 1px solid ${COLORS.sand};">
    <h2 style="color: ${COLORS.terracotta}; font-family: 'Outfit', sans-serif; font-size: 24px; margin-bottom: 20px;">Olá, ${name}!</h2>
    <p style="font-size: 16px;">Recebemos um pedido para redefinir sua senha no <strong style="color: ${COLORS.terracotta};">Petzara</strong>.</p>
...
exports.generateInviteCollaboratorEmail = (inviteUrl) => `
  <div style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; line-height: 1.6; color: ${COLORS.espresso}; background-color: ${COLORS.cream}; padding: 40px; border-radius: 24px; border: 1px solid ${COLORS.sand};">
    ...
    <p style="font-size: 16px;">Você foi convidado para colaborar no sistema <strong style="color: ${COLORS.terracotta};">Petzara</strong>.</p>
...
exports.generateWelcomeEmail = (name) => `
  <div style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; line-height: 1.6; color: ${COLORS.espresso}; background-color: ${COLORS.cream}; padding: 40px; border-radius: 24px; border: 1px solid ${COLORS.sand};">
    <h2 style="color: ${COLORS.terracotta}; font-family: 'Outfit', sans-serif; font-size: 24px; margin-bottom: 20px;">Bem-vindo ao Petzara, ${name}!</h2>
    <p style="font-size: 16px;">Estamos muito felizes em ter você como assinante 🎉</p>
    <p style="font-size: 16px;">A partir de agora você terá acesso completo ao nosso sistema de agendamento e gestão <strong style="color: ${COLORS.terracotta};">Petzara</strong>.</p>
...
exports.generateTrialEndingEmail = (name) => `
  <div style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; line-height: 1.6; color: ${COLORS.espresso}; background-color: ${COLORS.cream}; padding: 40px; border-radius: 24px; border: 1px solid ${COLORS.sand};">
    <h2 style="color: ${COLORS.terracotta}; font-family: 'Outfit', sans-serif; font-size: 24px; margin-bottom: 20px;">Olá, ${name} 👋</h2>
    <p style="font-size: 16px;">Seu período de teste de 30 dias no <strong style="color: ${COLORS.terracotta};">Petzara</strong> está quase acabando.</p>
    ...
    <p style="font-size: 16px;">Obrigado por confiar no <strong style="color: ${COLORS.terracotta};">Petzara</strong> 🐾</p>
  </div>
`;
...
exports.generateTrialEndedEmail = (name) => `
  <div style="font-family: 'Plus Jakarta Sans', Arial, sans-serif; line-height: 1.6; color: ${COLORS.espresso}; background-color: ${COLORS.cream}; padding: 40px; border-radius: 24px; border: 1px solid ${COLORS.sand};">
    ...
    <p style="font-size: 16px;">Seu período de teste de 30 dias no <strong style="color: ${COLORS.terracotta};">Petzara</strong> terminou.</p>
